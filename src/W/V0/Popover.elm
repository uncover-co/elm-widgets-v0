...
@docs over, offset, full, width, minWidth, displayBlock
...
displayBlock =
    Attribute <| \attrs -> { attrs | displayBlock = True }
...
view attrs_ props =
    ...
    in
    H.div
        [ HA.class "ew-popover ew-relative"
        , if not attrs.displayBlock then
            HA.class "ew-inline-flex"
