module W.V0.InputColor exposing
    ( view, viewReadOnly
    , disabled, readOnly
...
baseAttrs attrs_ value =
    let
        ...
        hexColor : String
        hexColor =
            W.V0.Internal.Color.toHex value
    in
...
view attrs_ props =
    H.input
        (HE.onInput (props.onInput << W.V0.Internal.Color.fromHex) :: baseAttrs attrs_ props.value)
        []
