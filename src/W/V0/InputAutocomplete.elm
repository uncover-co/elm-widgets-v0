module W.V0.InputAutocomplete exposing
    ( view, viewSync
...
import W.V0.Divider
import W.V0.Internal.Helpers as WH
import W.V0.Internal.Icons
import W.V0.Internal.Input
import W.V0.Loading
import W.V0.Menu
...
viewCustom attrs_ props =
    ...
    valueData.input
                ...
                H.input
                    (attrs.htmlAttributes
                        ++ [ WH.maybeAttr HA.placeholder attrs.placeholder
                           ...
                           , HA.id props.id
                           , HA.class (W.V0.Internal.Input.baseClass attrs.small)
                           , HA.class "ew-pr-10"
        ...
        |> W.V0.Internal.Input.viewWithIcon
            { small = attrs.small
            , prefix = attrs.prefix
            , suffix = attrs.suffix
            ...
            (if showLoading then
                W.V0.Loading.dots [ W.V0.Loading.size 20 ]

             else
                W.V0.Internal.Icons.chevronDown
            )
        |> (\x ->
                                ...
                                (options
                                    |> List.indexedMap
                                        (\viewIndex ( index, value ) ->
                                            W.V0.Menu.viewButton
                                                [ W.V0.Menu.selected (highlighted == viewIndex)
                                                ]
