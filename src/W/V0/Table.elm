    ...
    H.table
        (attrs.htmlAttributes
            ++ [ HA.class "ew-table ew-table-fixed ew-indent-0"
               , HA.class "ew-min-w-full ew-overflow-auto"
...
bool attrs_ props =
    let
        default : ColumnAttributes msg a
        default =
            columnAttrs props.label (\a -> W.V0.InputCheckbox.viewReadOnly [] (props.value a))
    in
    column_ { default | alignment = HA.class "ew-text-right" } attrs_
