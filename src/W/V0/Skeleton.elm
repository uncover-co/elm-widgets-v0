...
{-|
    ...
    W.V0.Skeleton.view [ W.V0.Skeleton.width 100, W.V0.Skeleton.height 100 ] []

    -- skeleton with custom size and no animation
    W.V0.Skeleton.view [ W.V0.Skeleton.width 100, W.V0.Skeleton.height 100, W.V0.Skeleton.noAnimation ] []
